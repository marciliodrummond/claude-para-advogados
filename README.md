...
- **`Claude-para-Advogados-do-Zero-ao-Senior.pdf`** — o manual final, pronto para ler, compartilhar e imprimir (A4).
- **`index.html`** — a versão web do manual (single-file, sem dependências além do Google Fonts).

## Conteúdo

- **Parte 0 — Antes de começar:** ecossistema e modelos de 2026, setup em 15 minutos, sigilo/LGPD/ética.
